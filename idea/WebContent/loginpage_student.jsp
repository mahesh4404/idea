...
<link href="/idea/css/Login_style.css" rel="stylesheet"
	type="text/css" />
...
<body>
	...
	<div class="bg-img">
		<div class="content">
			...
			<form action="r_studentloginverify.jsp" method="post">
				<div class="field">
			...
			<div class="signup">
				Don't have account? <a href="Student_Registration.jsp">Signup Now</a>
			</div>
		</div>
	</div>
